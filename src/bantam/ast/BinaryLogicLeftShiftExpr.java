/*
 * File: BinaryLogicLeftShiftExpr.java
...
/**
 * The BinaryLogicLeftShiftExpr class represents signed left shift expressions.
 ...
 */
public class BinaryLogicLeftShiftExpr extends BinaryLogicExpr {

    /**
     * BinaryLogicLeftShiftExpr constructor
     *
     * @param lineNum   source line number corresponding to this AST node
     * @param leftExpr  lefthand expression for bitwise OR-ing
     * @param rightExpr righthand expression for bitwise OR-ing
     */
    public BinaryLogicLeftShiftExpr(int lineNum, Expr leftExpr, Expr rightExpr) {
