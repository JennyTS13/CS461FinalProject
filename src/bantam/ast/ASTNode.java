...
public abstract class ASTNode {
    ...
    /**
     * List of comment and spacing associated with the ASTNode
     */
    protected List<Other> commentAndSpacingList;
    ...
    /**
     * Add an Other node to the end of the comment and spacing list
     * Initialize the list if it isn't initialized yet
     *
     * @param newCommentAndSpacing Other node to be added
     */
    public void addCommentAndSpacing(Other newCommentAndSpacing){
        if(commentAndSpacingList == null)
            commentAndSpacingList = new ArrayList<>();
        commentAndSpacingList.add(newCommentAndSpacing);
    }

    /**
     * Add an Other node to the front of the comment and spacing list
     * Initialize the list if it isn't initialized yet
     *
     * @param newCommentAndSpacing Other node to be added
     */
    public void addCommentAndSpacingToFront(Other newCommentAndSpacing){
        if(commentAndSpacingList == null)
            commentAndSpacingList = new ArrayList<>();
        commentAndSpacingList.add(0, newCommentAndSpacing);
    }

    /**
     * Add the list of Other nodes to the end of the comment and spacing list
     * Initialize the list if it isn't initialized yet
     *
     * @param newCommentAndSpacing List of Other nodes to be added
     */
    public void addCommentAndSpacing(List<Other> newCommentAndSpacing){
        if(commentAndSpacingList == null)
            commentAndSpacingList = new ArrayList<>();
        commentAndSpacingList.addAll(newCommentAndSpacing);
    }

    /**
     * Returns the list of comment and spacing associated with the ASTNode
     *
     * @return list of Other nodes associated with the ASTNode
     */
    public List<Other> getCommentAndSpacingList() {
        return commentAndSpacingList;
    }
