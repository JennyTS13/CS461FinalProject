/*
 * File: BinaryLogicBitAndExpr.java
...
/**
 * The BinaryLogicBitAndExpr class represents bitwise and expressions.
 ...
 */
public class BinaryLogicBitAndExpr extends BinaryLogicExpr {

    /**
     * BinaryLogicBitAndExpr constructor
     *
     * @param lineNum   source line number corresponding to this AST node
     * @param leftExpr  lefthand expression for bitwise OR-ing
     * @param rightExpr righthand expression for bitwise OR-ing
     */
    public BinaryLogicBitAndExpr(int lineNum, Expr leftExpr, Expr rightExpr) {
