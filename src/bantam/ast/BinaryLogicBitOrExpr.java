/*
 * File: BinaryLogicBitOrExpr.java
...
/**
 * The BinaryLogicBitOrExpr class represents bitwise or expressions.
 ...
 */
public class BinaryLogicBitOrExpr extends BinaryLogicExpr {

    /**
     * BinaryLogicBitOrExpr constructor
     *
     * @param lineNum   source line number corresponding to this AST node
     * @param leftExpr  lefthand expression for bitwise OR-ing
     * @param rightExpr righthand expression for bitwise OR-ing
     */
    public BinaryLogicBitOrExpr(int lineNum, Expr leftExpr, Expr rightExpr) {
