/*
 * File: BinaryLogicRightShiftExpr.java
...
/**
 * The BinaryLogicLeftShiftExpr class represents signed right shift expressions.
 ...
 */
public class BinaryLogicRightShiftExpr extends BinaryLogicExpr {

    /**
     * BinaryLogicRightShiftExpr constructor
     *
     * @param lineNum   source line number corresponding to this AST node
     * @param leftExpr  lefthand expression for bitwise OR-ing
     * @param rightExpr righthand expression for bitwise OR-ing
     */
    public BinaryLogicRightShiftExpr(int lineNum, Expr leftExpr, Expr rightExpr) {
