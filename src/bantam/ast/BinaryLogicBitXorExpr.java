/*
 * File: BinaryLogicBitXorExpr.java
...
/**
 * The BinaryLogicBitOrExpr class represents bitwise xor expressions.
 ...
 */
public class BinaryLogicBitXorExpr extends BinaryLogicExpr {

    /**
     * BinaryLogicBitXorExpr constructor
     *
     * @param lineNum   source line number corresponding to this AST node
     * @param leftExpr  lefthand expression for bitwise OR-ing
     * @param rightExpr righthand expression for bitwise OR-ing
     */
    public BinaryLogicBitXorExpr(int lineNum, Expr leftExpr, Expr rightExpr) {
