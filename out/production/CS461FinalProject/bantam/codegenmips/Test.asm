...
String_const_48:
	...
	.ascii	"-32 >>> 4 "
	.byte	0x9
	.ascii	" expected: 268435454; actual: "
	.byte	0
	.align	2
String_const_49:
	.word	1
...
FunctionalityTest.testAssignExpr:
	...
	add $sp $sp -4
	sw $v0 0($sp)
	# evaluate right side of plus equals expr
	# load int value into $v0
	li $v0 7
	# pop value of left expr off stack into $v1
	lw $v1 0($sp)
	add $sp $sp 4
	add $v0 $v0 $v1
	sw $v0 0($fp)
...
label19:
	...
	sw $v0 0($sp)
	# Computing parameters and pushing onto stack
	# binary signed right shift expr
	# evaluate right expr
	# evaluate value to negate
	# load int value into $v0
	li $v0 4
	...
	lw $v1 0($sp)
	add $sp $sp 4
	# find the positive number of bits to shift, store in $t1
	rem $t1 $v1 32
	add $t1 $t1 32
	rem $t1 $t1 32
	# Load -1 into $t2, if the result is -1, break
	li $t2 -1
	# shift left expr($v0) by $t1 bits
	# same as dividing $v0 $t1 times
label21:
	beq $v0 $t2 label20
	div $v0 $v0 2
	sub $t1 $t1 1
...
label26:
	...
	sw $v0 0($sp)
	# Computing parameters and pushing onto stack
	# binary unsigned right shift expr
	# evaluate right expr
	# evaluate value to negate
	# load int value into $v0
	li $v0 4
...
label31:
	...
	# negate value in $v0 
	neg $v0 $v0
	# pop result of left expr off stack onto $v1
	lw $v1 0($sp)
	add $sp $sp 4
	and $v0 $v0 $v1
	# push param onto stack
