...
#	 nop
	...
	.globl TextIO.putInt
	.globl Note.setNoteAttributes
	.globl Note.getPitch
	.globl Note.getDuration
	.globl Note.getInstrument
	.globl Note.getVolume
	.globl MidiHandler.play
	.globl MidiHandler.rest
...
Note.setNoteAttributes:
	...
	# Now starts the body of method setNoteAttributes
	# if statement
...
Note.getPitch:
	...
	# Now starts the body of method getPitch
...
Note.getDuration:
	...
	# Now starts the body of method getDuration
	# evaluate return value
	# load field from stack to $v0
	lw $v0 16($a0)
	# Starting epilog of method
...
Note.getInstrument:
	...
	# Now starts the body of method getInstrument
	# evaluate return value
	# load field from stack to $v0
	lw $v0 20($a0)
	# Starting epilog of method
...
Note.getVolume:
	...
	# Now starts the body of method getVolume
	# evaluate return value
	# load field from stack to $v0
	lw $v0 24($a0)
	# Starting epilog of method
...
MidiHandler.play:
	...
	# Now starts the body of method play
	# code for call to getPitch
	# Saving important registers
	add $sp $sp -4
	sw $a0 0($sp)
	add $sp $sp -4
	...
	# Loading obj ref into $a0
	lw $a0 0($sp)
	# Finding location of code to execute: getPitch
	# ptr to vtf is the 3rd slot, 8 bytes down
	lw $t0 8($a0)
	# loading method location into $t0
	lw $t0 16($t0)
	...
	# Loading obj ref into $a0
	lw $a0 0($sp)
	# Finding location of code to execute: getDuration
	# ptr to vtf is the 3rd slot, 8 bytes down
	lw $t0 8($a0)
	# loading method location into $t0
	lw $t0 20($t0)
	...
	# code for call to getInstrument
	# Saving important registers
	add $sp $sp -4
	sw $a0 0($sp)
	add $sp $sp -4
	...
	# Loading obj ref into $a0
	lw $a0 0($sp)
	# Finding location of code to execute: getInstrument
	# ptr to vtf is the 3rd slot, 8 bytes down
	lw $t0 8($a0)
	# loading method location into $t0
	lw $t0 24($t0)
	...
	# Loading obj ref into $a0
	lw $a0 0($sp)
	# Finding location of code to execute: getVolume
	# ptr to vtf is the 3rd slot, 8 bytes down
	lw $t0 8($a0)
	# loading method location into $t0
	lw $t0 28($t0)
...
MidiHandler.rest:
	...
	# Now starts the body of method rest
    # sleep syscall
    move $a0 $v0
    li $v0 32
    syscall
